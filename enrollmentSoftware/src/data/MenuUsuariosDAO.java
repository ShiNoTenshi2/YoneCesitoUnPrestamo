...
public class MenuUsuariosDAO {
    private static MenuUsuariosDAO instance;
    private ArrayList<User> userList = new ArrayList<>();
    private DBConnection dbConnection = DBConnection.getInstance();

    private MenuUsuariosDAO() {
        // Constructor privado para singleton
    }

    public static MenuUsuariosDAO getInstance() {
        if (instance == null) {
            instance = new MenuUsuariosDAO();
